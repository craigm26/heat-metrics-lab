# CLAUDE.md — heat-metrics-lab

> **Claude Code reads this file at session start.** Content is identical to [AGENTS.md](./AGENTS.md) — both files reference the same context and are kept in sync. If drift occurs, update both. For the public-facing project overview, see [README.md](./README.md).
